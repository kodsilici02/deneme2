  ...
  <div class="container-fluid w-100 bg">
    <main>
      <article class="w-full sm:w-10/12">
        <h1 class="text-3xl sm:text-5xl">About</h1>
        <section v-for="title in titles" :key="title.id">
          <div
            ref="title"
      ...
      <aside class="hidden sm:block sm:w-2/12">
        <div class="sticky-container p-0" style="top: 0px">
          ...
          >
            <h2
              class="text-3xl sm:text-base md:text-2xl font-bold sideh2"
              v-bind:accesskey="title.id"
